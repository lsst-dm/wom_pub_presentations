...
of nuisance parameters - required for realistic modelling (e.g. attitude, instrument calibration)
...
\frame {\frametitle{ Look at one block: Source modelling }
%\vspace{-15pt}
The mapping or modelling  of
the observables
