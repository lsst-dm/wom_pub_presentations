...
\frame { \frametitle{ Site shaping up }
	...
	\includegraphics[width=0.8\textwidth,trim=0cm 0cm 0 0cm,clip]{images/cerroMay2018}

\begin{itemize}
	\item Dome interface and Telescope Mount Assembly (TMA) topple block installed
	\item But construction is late and its been snowing..
\end{itemize}
}
