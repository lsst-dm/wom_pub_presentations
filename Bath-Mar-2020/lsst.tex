...
\begin{itemize}
   ...
   \item \url{developer.lsst.io} is a full developer guide - everythign from git commit messages to style guides for Python adn C+.
   \item \url{pipelines.lsst.io} documents the main software release(s)
	\begin{itemize}
	\item worst of both worlds - it is a monolitic release  - but made up of > 120 git repos
...
\item  Language (spoken/written) and conventions are also super important
    \begin{itemize}
	    ...
	    \item {\color{blue} - on RubinObs we lack something foundaitonal like \citeds{LL:BAS-003}}
    \end{itemize}
