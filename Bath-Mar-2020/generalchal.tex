...
\item And then there is machine learning!
	\begin{itemize}
	\item  Automated discovery - need it great !
	\item Reproducibility, understandability ..
	\end{itemize}
\end{itemize}
}
...
\item We need to consider  long term software support and the software eco system
	...
	\end{itemize}
\item Education and outreach - How do we do better?
	\begin{itemize}
	\item Does everyone need to be a data scientist/programmer ?
	\item Educate astronomers/managers on how to \emph{open source}
	\item How do we foster inclusion ?
	\end{itemize}
\end{itemize}
}
