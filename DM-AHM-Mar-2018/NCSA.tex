...
\begin{column}{0.5\textwidth}
\includegraphics[width=1\textwidth]{EIA-TUCSON-2018}
\end{column}
\end{columns}
...
\begin{itemize}
    ...
    \item Regular dataset reprocessing  for developers based on biweekly stack updates.
...
\includegraphics[width=\textwidth]{NCSA-2018}
\end{column}
\end{columns}
...
\frame[allowframebreaks]{\frametitle{NCSA - 2018 plans }
\vspace{-3pt}
\begin{itemize}
\item  AuxTel Operations (Fall) (LSST- and DM-level milestones)
    ...
    \item Data transfer to NCSA, ingestion and archiving into Data Backbone (single site).
...
Plug for UIUC/NCSA-hosted Visualization workshop - Talk to Felipe Menanteau
\url{ https://www.lsstcorporation.org/node/160}
}
