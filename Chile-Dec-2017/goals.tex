 ...
 \begin{itemize}
   \item{2017: Prototyping data access and first access to hardware}
      \begin{itemize}
        ...
        \item{Dec: Robust coadd available in Stack}
     \end{itemize}

   \item{2018: Prototypes for various processes and databases - ``Minimum Viable System''}

     \begin{itemize}
       \item{Jan: Jointcal replace meas\_mosaic}
       \item{Jun: At-scale test of Alert Distribution}
   ...
   \item{Jun 2022: Chilean Data Access Center Integrated (\citeds{LDM-572})}
 \end{itemize}
 \begin{center}
\vspace{-8pt}
