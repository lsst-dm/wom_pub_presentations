...
\frame{\frametitle{ Gaia Added Value Interface Platform (GAVIP)}

  \includegraphics[width=0.5\textwidth] {gaiaim/GAVIPOverview}
  \includegraphics[width=0.5\textwidth] {gaiaim/GAVIP} \\

  \vspace{10pt}
  Bringing code to the data \cite{2016SPIE.9913E..1VV}
}
...
This is the sort of envronment users now {\emph expect} to have - it is no longer novel.

{\bf Bruno will have more to say on this }
}
